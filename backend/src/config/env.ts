...
export const env = {
  ...
  restaurantEmail: process.env.RESTAURANT_EMAIL ?? process.env.MAIL_FROM ?? 'webernardocsf@gmail.com',
  smtpHost: process.env.SMTP_HOST ?? 'smtp.gmail.com',
  smtpPort: Number(process.env.SMTP_PORT ?? 587),
  smtpSecure: process.env.SMTP_SECURE === 'true',
  smtpUser: process.env.SMTP_USER ?? process.env.MAIL_FROM ?? 'webernardocsf@gmail.com',
  smtpPass: process.env.SMTP_PASS,
  mailFrom: process.env.MAIL_FROM ?? 'webernardocsf@gmail.com',
